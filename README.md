...
В рамках задания решалась задача кластеризации сигналов, которые необходимо разделить на три кластера.
...
Сравнил три модели: KMeans, Gaussian Mixture Model (GMM) и DBSCAN. DBSCAN показал себя плохо, GMM показала лучший силуэтный коэффициент (0.406670) по сравнению с KMeans (0.379341), поэтому выбрал GMM для дальнейшей работы.
